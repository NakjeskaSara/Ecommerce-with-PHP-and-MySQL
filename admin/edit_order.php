...
?>
  ...
  <?php
     if(isset($_GET['order_id'])){
        ...
        if($stmt->execute()) {
            header('location: index.php?order_updatede=Order has been updated successfully');
        } else {
...
<div class="container-fluid">
    ...
    <main class="col-md-9 ms-sn-auto col-lg-10 px-md-4 d-flex justify-content-center">
    <div class="text-left">

             <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-radius-center text-center">
